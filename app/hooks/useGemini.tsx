...
export default function useGemini() {
  ...
  const handleImageUpload = async (file: any) => {
    try {
      ...
      updateMessage((prevMessages: any) => [...prevMessages, imageMessage]);
  ...
  const sendMessages = async (payload: any) => {
    // Ensure the first message has role 'user'
    updateMessage((prevMessages: any) => [
      ...prevMessages,
    ...
    try {
      ...
      const adjustedPayload = {
        ...
        history: payload.history.map((msg: any) => {
